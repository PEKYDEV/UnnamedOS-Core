...
- Az [ADR-0016](0016-higher-half-elf-and-dual-address-contract.md) külön buildelt higher-half ELF-et, egységes VMA–LMA fordítást és hoston bizonyított mapping/page-table tervet ad; runtime aktiválást nem végez.
